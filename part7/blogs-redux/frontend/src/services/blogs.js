...
export const comment = async (blogId, comment) => {
  const config = getToken()

  return await axios.post(`${baseUrl}/${blogId}/comments`, {comment}, config)
}

export default { getAll, setToken, createBlog, incrementBlogLikes, remove, comment }